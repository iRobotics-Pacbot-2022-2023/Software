...
const pair<int, int> GHOST_STARTING_POSITIONS[4] = {
    pair<int, int>(13, 11),
    pair<int, int>(13, 12),
    pair<int, int>(13, 13),
    pair<int, int>(13, 14)
...
// extern int PELLETS_EATEN = 0;
// extern int CHERRIES_EATEN = 0;
// extern int POWERUPS_EATEN = 0;

// extern vector<vector<int>> GRID = {{I,I,I,I,I,I,I,I,I,I,I,I,e,e,e,I,I,I,e,e,e,I,I,I,I,I,I,I,I,I,I}, // 0
