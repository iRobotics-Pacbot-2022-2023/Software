...
int main () {
    ...
    vector<vector<int>> testgrid = {{I, I, I, I, I},
                                    {I, o, o, o, I},
                                    {I, o, I, o, I},
                                    {I, o, I, o, I},
                                    {I, I, I, I, I}};                                   
    ...
    int curr_powerup = 0;
    int cherries_eat = 0;
    PacmanState pac(pos, PacmanState::Direction::right, testgrid, pelletsLeft, pellets_eat, cherries_eat, curr_powerup);

    std::pair<int, int> ghostLoc = {1, 1};
    std::pair<int, int> scatterLoc = {1, 1};
    Ghost ghost(ghostLoc, scatterLoc, pos, Ghost::Direction::up, Ghost::GhostState::chase);

    Ghost ghost_blue(ghostLoc, scatterLoc, pos, Ghost::Direction::up, Ghost::GhostState::chase);
